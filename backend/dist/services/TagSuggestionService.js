...
exports.TagSuggestionService = void 0;
...
class TagSuggestionService {
     ...
     */
    static async suggestTags(title, content, existingTags = []) {
        try {
     ...
     */
    static hasSignificantChange(oldContent, newContent) {
    ...
    static buildPrompt(title, content, existingTags) {
...
exports.TagSuggestionService = TagSuggestionService;
//# sourceMappingURL=TagSuggestionService.js.map